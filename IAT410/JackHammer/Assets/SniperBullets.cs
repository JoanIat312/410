...
public class SniperBullets : MonoBehaviour
{
...
//  defaultDamage = 20;
 ...
 {
  if (col.gameObject.tag == "wall" && gameObject.name != "sniperBullets")
  {
   hitWall = true;
  ...
  if (col.gameObject.tag == "Player" && gameObject.name != "sniperBullets")
  {
 ...
 void FixedUpdate ()
 {
  ...
  if (gameObject.name != "sniperBullets")
  {
   if (hitWall == true) {
